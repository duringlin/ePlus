...
public interface SlidActivityBase {
	...
	/**
	 * Open the SlidMenu and show the secondary (right) menu view. Will default to the regular menu
	 ...
	 */
	public void setSlidActionBarEnabled(boolean slidingActionBarEnabled);
